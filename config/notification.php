...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | must be implement from \IICN\Notification\TransactionalData
    |
    | default is \IICN\Notification\Services\Transaction\TransactionalData::class
    |
    */
    'additional_data_transaction' => \IICN\Notification\Services\Transaction\TransactionalData::class,
